...
Plans:
- [ ] 02-01-PLAN.md — [Wave 1 RED] Favorite/Analysis/Collection/CollectionMembership 모델 테스트 작성
- [ ] 02-02-PLAN.md — [Wave 1 RED] UrlNormalizer/UrlSafetyValidator/UrlTypeDetector 서비스 테스트 작성
- [ ] 02-03-PLAN.md — [Wave 2 GREEN] DB 마이그레이션 4개 + 모델 4개 구현
- [ ] 02-04-PLAN.md — [Wave 3 GREEN] URL 서비스 3개 구현
