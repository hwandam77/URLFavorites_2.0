...
require Rails.root.join("app/url_favorites/use_cases/link_roundup/plan_sections").to_s

class PlanLinkRoundupJob < ApplicationJob
  MAX_RETRIES = 3
  ...
  def perform(favorite_id, analysis_snapshot)
    UrlFavorites::UseCases::LinkRoundup::PlanSections.call(
